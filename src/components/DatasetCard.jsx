    ...
    >
      ...
      <div className="relative p-5 z-[2]">
        ...
        <div className="flex items-start justify-between gap-3 mb-2">
          <h3 className="text-[15px] font-semibold text-slate-800 dark:text-slate-50 leading-snug">
            {dataset.name}
          </h3>
          <span className="shrink-0 px-2.5 py-0.5 text-[10px] font-bold rounded-full
        ...
        <div className="flex flex-wrap gap-1.5 mb-4">
          {dataset.tags.map((tag, idx) => (
            <span
              ...
              className={`px-2.5 py-0.5 text-[11px] rounded-full font-medium border ${
                idx % 3 === 0
        ...
        <button
          ...
          className="relative w-full overflow-hidden rounded-xl px-4 py-2 text-sm font-semibold text-white
