...
import { Bot, BookOpen, Network, PenLine, Users, ShieldCheck, Check, XCircle } from 'lucide-react';
  ...
  return (
    <section id="expert-data" className="relative py-28 overflow-hidden bg-white dark:bg-slate-900">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Flowchart container — centered card */}
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col items-center flex-shrink-0 w-12">
                    ...
                    {/* Arrow tip before gate (last connector) */}
